...
const Payment = () => {
  ...
  useEffect(() => {
    const orderData = JSON.parse(localStorage.getItem("latestOrder") || "") as OrderData;
  ...
  const cashOnDeliveryHandler = async (e: { preventDefault: () => void }) => {
    e.preventDefault();
  };
    ...
    <div className="w-full 800px:w-[95%] bg-[#fff] rounded-md p-5 pb-8">
      ...
      <div>
        ...
        {select === 2 ? (
          <div className="w-full flex border-b">
            <div
              className={`${lwpStyles.button} !bg-[#f63b60] text-white h-[45px] rounded-[5px] cursor-pointer text-[18px] font-[600]`}
